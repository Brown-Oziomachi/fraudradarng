...
export const guides: Guide[] = [
 {
    ...
    preview:
      'Hackers gain access to your Facebook or Instagram ad account and run thousands of naira in ads to their own pages using your payment method. By the time you notice, the damage is done. Here is exactly how ad account hacking works and how to lock yours down completely.',
    category: 'Account & Identity Security',
...
Nigerian businesses have absorbed losses of hundreds of thousands of naira from ad account hacking — losses that were entirely preventable with basic security practices.
...
Two-factor authentication. Unique password. Regular access audits. These three things alone eliminate most of the risk. Implement them today — before you need to.`,
  },
  {
    ...
    preview:
      'Fake CAC registration agents are collecting money and documents from Nigerian entrepreneurs and disappearing. Here is how business registration scams work and the only safe way to register your business in Nigeria.',
    category: 'Business & Investment Safety',
...
A registration scam should not steal your money or discourage you from formalizing your business. The CAC portal exists. Official agents exist. The process is accessible.
...
Do it the right way. Verify everything. And protect your documents with the same care you give to your money.`,
  },
  {
    ...
    preview:
      'A brand offers you a paid partnership, sends a fake transfer, and asks you to promote them before you confirm. Or they overpay and request a refund. Here is exactly how fake brand deal scams work and how every Nigerian content creator can protect themselves.',
...
Pursue those opportunities with a verification process that protects you. Research every brand. Confirm payment before posting. Use contracts. And trust your instincts when something feels too fast or too easy.
...
Your audience trust is your most valuable asset as a creator. A scam brand post does not just cost you money — it costs you credibility. Protect both.`,
  },
  {
    ...
    preview:
      'Moniepoint and OPay have become the scammer\'s favourite weapons against Nigerian small business owners. Here is exactly how these fake transfer alerts work on both platforms and what you must do to protect your money.',
    category: 'Business & POS Fraud',
...
Too many hardworking Nigerian entrepreneurs have lost goods, money, and sometimes entire businesses to fake transfer alerts on these two platforms. This article exists because awareness is the most powerful defence you have.
...
OPay fake alerts follow the same pattern but with one additional manipulation worth knowing specifically.
...
2. Real buyers are never in a hurry to skip your verification. A legitimate customer who genuinely paid you will wait patiently while you confirm. They know the money left their account. They are not worried. Only someone who knows no money moved will pressure you to skip confirmation.

3. No confirmation, no release. Make this your non-negotiable business policy. Write it on your page. Say it out loud when taking orders. "I release only after payment confirms in my app." Say it once, say it clearly, and mean it every time.

4. Processing means nothing. If a customer says their transfer is "processing," your goods stay with you until it finishes processing and appears in your app. You are not a bank. You are not responsible for their transfer delays. Your obligation begins when money reaches you — not before.

5. Use payment links when possible. Paystack, Flutterwave, and Squad allow you to generate payment links that customers can pay through directly. When payment is made through a link, you receive confirmation on your merchant dashboard — not just an SMS. This eliminates the fake alert risk entirely for online transactions.
...
The knowledge in this article is free. Use it. Share it. And never release goods on an SMS alone again.`,
  },
  {
    ...
    preview:
      'Three payment processors, three completely different experiences for Nigerian businesses. After building real integrations, here is an honest comparison — not marketing copy.',
    category: 'Business & Investment Safety',
...
There's no single "best" answer — there's only the right tool for where your customers are and how you need to receive money. Choose based on the full transaction loop, not just the checkout experience.`,
  },
  {
    ...
    preview:
      'Most failed businesses didn\'t fail because of bad execution — they failed because nobody actually wanted what was being sold. Here is how to find that out before you spend a single naira.',
    category: 'Business & Investment Safety',
    datePublished: '2026-03-02',
    image: '/idea-validation.jpg',
...
The businesses that survive aren't the ones with the cleverest idea — they're the ones that found real, paying demand before spending serious money or time building. Validate the problem before you fall in love with your solution.`,
  },
  {
    ...
    preview:
      'Most new business owners budget for stock and rent, then get blindsided by everything else. Here is the full real cost picture nobody puts in one place.',
    category: 'Business & Investment Safety',
...
Most businesses don't fail because the idea was bad — they fail because the real cost of operating was never fully counted, and the business ran out of room to survive its own early months. Count everything, then add a buffer, before you commit.`,
  },
  {
    ...
    preview:
      'Should you register your business right away, or wait until it\'s making money? Here is a clear-headed breakdown of what registration actually unlocks, and when informal operation is genuinely fine.',
    category: 'Business & Investment Safety',
...
ATM safety requires active, physical inspection every single time you use a machine. Thirty seconds of checking before you insert your card could save your entire account balance. Your money is worth those thirty seconds.`,
  },
  {
    ...
    preview:
      'The same technology powering customer service chatbots and creative tools is being weaponized by criminals to run fraud operations at a scale previously impossible.',
    category: 'Account & Identity Security',
...
AI-powered fraud is not a future threat. It is the current reality. The defense is not technology — it is behavioral. Verify every financial request through an independent official channel. Never act immediately under emotional pressure. Slow down every time money is involved.`,
  },
  {
    ...
    category: 'Consumer Awareness & Protection',
...
Your tagged family photos on Facebook make this mapping effortless. A fraudster can identify your mother, your spouse, your siblings, and your children by name from your public profile in minutes. They can find your mother's phone number from her own public profile. They now have everything they need to call her and say: "Good afternoon ma, I am calling about your son. There is an issue with his account and he asked me to reach you urgently."
...
Modern fake banking websites are not amateur scams. They are engineered operations using the same code, the same design, and the same user experience as the real institutions they impersonate. The technical gap between real and fake has narrowed to a single line of text in your browser's address bar. That address is the only thing you can fully trust — and learning to read it carefully is the most important digital security skill you can develop.`,
  },
  {
    ...
    preview:
      'Digital thieves do not look for the vaults in banks anymore; they look for the vulnerabilities in you. Your BVN and NIN are not just numbers — they are the master keys to your financial existence.',
    category: 'Account & Identity Security',
    datePublished: '2026-02-13',
    image: '/fin.jpeg',
    content: `The modern bank robber doesn't wear a mask or carry a firearm. They sit in dimly lit rooms, manipulating psychological vulnerabilities and exploiting technical loopholes. In emerging markets like Nigeria, the transition to cashless banking has created an underground economy built entirely on identity arbitrage. Fraudsters do not break into bank servers; they invite themselves into your phone by convincing you to open the door.
...
1. **The Manufactured Crisis or Windfall.** Fraud thrives on urgency. If an SMS or email claims your account is "temporarily locked due to updates," or conversely, that you have won a federal grant or cash prize, it is a psychological trigger designed to make you act before you think.

2. **The Look-Alike Domain (Typosquatting).** Legitimate entities use strictly secured corporate domains. Fraudsters buy domains that look 95% identical to your bank or fintech provider (e.g., accessbvanck.com instead of accessbankplc.com). Always inspect the URL closely; if it lacks standard secure protocols or displays slight structural alterations, abort.
...
2. **The Central Bank/NIBSS Intervention.** Contact the Nigeria Inter-Bank Settlement System (NIBSS) or visit your primary banking branch to place a watch-list tag on your BVN. This alerts the central system to monitor and block any new account creation or loan applications across all Nigerian financial networks using your identity.

3. **Legal and Regulatory Insulated Cover.** File an official report at the nearest police station or cybercrime unit and secure a police diary entry or affidavit. This document is your shield; it proves the exact date and time your identity was compromised, legally clearing you if your details are later used to execute criminal transactions.
...
Digital security is not a product you buy; it is a habit you practice. Your BVN and National Identification Number are your digital DNA. Treat them not like casual account numbers, but like the physical keys to your home. Protect them with a healthy dose of digital paranoia, because in the online space, a single moment of unvetted trust can take months of systemic work to repair.`,
  },
  {
    ...
    title: 'The Naked Account Number: How Cybercriminals Turn a 10-Digit String into a Financial Weapon',
    preview:
      'Your 10-digit bank account number seems harmless enough to share, but to a seasoned fraudster, it is the first piece of a jigsaw puzzle.',
    category: 'Banking Safety',
...
Your bank account number is the front door to your financial home. While people can see it, they cannot enter unless you hand them the keys. By maintaining strict control over your OTPs, PINs, and personal data, you ensure that your account number remains nothing more than a harmless string of digits.`,
  ...
  {
    slug: 'fake-job-offer-recruitment-scam-nigeria',
    title: 'The Fake Job Offer: How Recruitment Scams Are Draining Nigerian Job Seekers',
    preview:
      'A "hiring manager" offers you a remote job with a great salary, then asks for a fee to process your laptop, training materials, or work permit. Here is exactly how recruitment scams work and how to tell a real offer from a fake one.',
    category: 'Consumer Awareness & Protection',
    datePublished: '2026-04-02',
    image: '/job-scam.jpg',
    content: `You applied to a job posting that looked perfect — remote work, a strong salary in dollars or naira, flexible hours. Within days, sometimes hours, you get a message. No interview, or a suspiciously short one over chat. You're hired.

Then comes the request. A fee for your "starter kit." A payment to "activate" your staff account. A charge for a work permit, a laptop deposit, or training materials that will be "refunded in your first paycheck."
...
Check the recruiter's own LinkedIn profile. A real recruiter has a history, connections, and a consistent employment record. A profile created recently with few connections and generic activity is a warning sign.

Ask for a video call with your camera and theirs on, through a mainstream platform like Zoom or Google Meet — not a random app the recruiter insists on. Legitimate companies are comfortable with this. Scammers often resist or make excuses.
...
Report the recruiter's profile and any job posting platform involved so the account can be taken down before it reaches more people.
...
A real job offer never costs you money to accept. That single rule, applied without exception, closes off almost every version of this scam. If a hiring process ever asks you to pay before you're paid, the process has already told you everything you need to know.`,
  ...
  {
    slug: 'romance-scam-dating-app-fraud-nigeria',
    title: 'The Long Con: How Romance Scams Build Trust for Months Before Asking for Money',
    preview:
      'Romance scammers don\'t ask for money on day one. They invest weeks or months building a relationship first, because trust is the entire mechanism the scam depends on. Here is how the pattern unfolds and how to recognize it while it is still happening.',
    category: 'Social Media & Impersonation',
    datePublished: '2026-04-04',
    image: '/romance-scam.jpg',
    content: `Romance scams are unusual among financial frauds because the crime is not the request for money — that comes late, sometimes very late. The crime is the relationship itself, built deliberately and patiently for the sole purpose of making the eventual request feel unrefusable.
...
Early conversation is warm, attentive, and consistent. Scammers running these operations often manage several targets at once and follow scripts refined over many previous attempts, which means the conversation can feel remarkably natural and responsive. They mirror your interests, remember details you've shared, and message consistently enough to build a real sense of routine and closeness.
...
Insist on an unscheduled, spontaneous video call early in the relationship, not one arranged days in advance. Scammers using stand-in actors or manipulated footage struggle far more with unscheduled requests.

Never send money, gift cards, or cryptocurrency to anyone you have not met in person, regardless of how long you have been talking or how genuine the relationship feels. This rule holds even after months of contact — length of relationship is not evidence of legitimacy in a digital-only connection.
...
Romance scams succeed because they invert the usual order of financial fraud — trust is built first, deliberately and patiently, and the request for money comes only once that trust feels unbreakable. Recognizing the pattern early, before the emotional investment deepens, is the only reliable protection. No one who genuinely cares about you will make their care conditional on money you send to someone you have never met.`,
  ...
  {
    slug: 'crypto-investment-ponzi-scheme-nigeria',
    title: 'Guaranteed Returns Don\'t Exist: How Crypto and Investment Ponzi Schemes Trap Nigerians',
    preview:
      'Fake investment platforms have defrauded hundreds of thousands of Nigerians of billions of naira using the same core mechanism — early "returns" paid from new investors\' money, not real profit. Here is how to recognize the pattern before you invest.',
    category: 'Business & Investment Safety',
    datePublished: '2026-04-07',
    image: '/ponz.jpeg',
    content: `Investment fraud in Nigeria has evolved dramatically from the crude "double your money" schemes of a decade ago into polished platforms with professional apps, dashboards showing real-time "profit," and testimonials from apparently satisfied investors. The packaging has changed. The underlying mechanism has not.
...
**Returns that sound modest but compound to something absurd.** "Just 1% per day" sounds small until you calculate it over a year — it compounds to returns no legitimate investment vehicle on earth can sustainably produce. Scammers use small daily numbers specifically because they sound conservative while being mathematically impossible over time.

**Heavy emphasis on recruiting others.** If the platform's structure rewards you significantly more for bringing in new investors than for the investment itself, you are looking at a referral-funded scheme, not an investment product. This is often the clearest tell of all, because legitimate investment platforms have no fundamental need for you to recruit anyone.

**Withdrawal friction that appears only after you try to take out a large amount.** Many schemes allow smooth, fast withdrawals of small amounts specifically to build confidence, then introduce delays, additional "verification fees," or outright refusal once an investor attempts to withdraw a significant sum or their full balance.

**Vague or unverifiable claims about how profit is generated.** Ask specifically what the platform invests in and how profit is produced, and listen for a real answer versus buzzwords. "Our AI trading bot exploits micro-arbitrage across twelve exchanges" is a sentence that sounds technical while explaining nothing verifiable.
...
Ask for the specific mechanism of profit generation and independently verify it makes sense. If explaining how the platform makes money requires jargon rather than a concrete, checkable business activity, treat that as disqualifying.

Never invest money you cannot afford to lose completely, regardless of how confident you feel or how many people you know are already involved. Every Ponzi scheme has satisfied early investors — their satisfaction is not evidence of legitimacy, it is the fuel that keeps the scheme running.

Attempt a full withdrawal early, with a modest amount, specifically to test the platform's honesty about access to your funds — not just deposit and profit visibility.
...
Document everything — screenshots of the platform, your deposits, any communication, and the app or website itself — before it potentially goes offline.
